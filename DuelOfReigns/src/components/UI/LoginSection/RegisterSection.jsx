        ...
        createUserWithEmailAndPassword(auth, email, password)
            .then((userCredential) => {
                ...
                updateProfile(user, {displayName: pseudo})
                    ...
                    .catch((error) => {
                        setMessage(`${t("register.form.error.displayName")}} ${error} ${error.message}`);
                    });
                ...
                <Col lg="6" className="form__section d-flex align-items-center">
                    {registered ? <Toast className={"login__form"}>
                        ...
                        <ToastBody className={"d-flex flex-column"}>
                            ...
                            >
                                <Button
                                    color="primary"
                                    outline
                                    className="btn__account btn btn-outline-warning"
                                >
                                        <span>
                        ...
                        <Form onSubmit={handleRegister}>
                            ...
                            <div className="mb-3">
                                <label htmlFor="confirmEmail" className="form-label">Confirme adresse
                                    Mail</label>
